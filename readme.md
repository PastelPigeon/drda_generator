...
| **脸图**   | `[face=spr_face_susie_alt_0]说话[/face]`                       | 指定这段文字出现时显示的角色头像。<br>参数是头像文件名（不加路径和后缀）。<br>（素材包在 `assets/character_faces/` 或 [下载链接](https://wwjo.lanzouu.com/iGfdO32j24ri)） | **核心功能！** 设置对话时使用的脸图                                      |

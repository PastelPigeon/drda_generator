...
func _on_text_submitted(new_text: String):
	...
	# 设置资产属性
	ExternalAssetsManager.set_asset_attribute_DIALOGUE_TEXTURES(AssetsManagerDataManager.selected_key, AssetsManagerDataManager.selected_index, int(new_text), ExternalAssetsManager.get_asset_info(AssetsManagerDataManager.selected_asset_type, AssetsManagerDataManager.selected_key, AssetsManagerDataManager.selected_index)["text_animation_state"])
